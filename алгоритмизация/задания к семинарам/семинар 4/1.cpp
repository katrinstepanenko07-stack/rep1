...
// int main() {
//     int n = 0, max_size = 100;
//     std::cout << "Ведите размер квадратной матрицы: ";
//     std::cin >> n;
//     int matrix[max_size][max_size], matrix1[max_size][max_size], matrix2[max_size][max_size], matrix3[max_size][max_size], matrix4[max_size][max_size]; 
...
//     } else if (coincided(matrix1, matrix3, n)) {
//         std:: cout << "матрицы 1 и 3 совпали)" << std::endl;
//     } else if (coincided(matrix1, matrix4, n)) {
//         std:: cout << "матрицы 1 и 4 совпали)" << std::endl;
//     } else if (coincided(matrix2, matrix3, n)) {
//         std:: cout << "матрицы 2 и 3 совпали)" << std::endl;
//     } else if (coincided(matrix2, matrix4, n)) {
//         std:: cout << "матрицы 2 и 4 совпали)" << std::endl;
//     } else if (coincided(matrix3, matrix4, n)) {
